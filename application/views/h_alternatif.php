...
<?php include 'navbar.php' ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Hitung Alternatif (Menggunakan Metode SAW)</h1>
          </div>
          ...
          <div class="row">
                ...
                <table class="table table-head-fixed">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url('dashboard/detail_alternatif/'.$k->id_keputusan) ?>" class="btn btn-sm btn-success"><span class="fas fa-search-plus"></span></a>
                      </td>
                    </tr>
                    <?php }} else { ?>
            ...
            <div class="col-lg-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Hitung Alternatif</h6>
                </div>
                <div class="card-body">
                  <!-- form tambah keputusan -->
                  <form role="form" action="input_alternatif_kriteria" method="post">
                  <div class="card-body">
